...
//  Top Advertisement Image
   ...
   $wp_customize->add_control('madarlite_search_icon_in_menu', array(
	...
	$wp_customize->add_control('insta_link',array(
			'label'	=> __('Add Instagram link here','madar-lite'),
			'section'	=> 'social_sec',
			'setting'	=> 'insta_link'
	));	
   ...
   $wp_customize->add_panel('madarlite_category_color_panel', array(
      'priority' => 535,
      'title' => __('Category Color Options', 'madar-lite'),
      'capability' => 'edit_theme_options',
      'description' => __('Change the color of each category items as you want.', 'madar-lite')
   ));

   $wp_customize->add_section('madarlite_category_color_setting', array(
      'priority' => 1,
      'title' => __('Category Color Settings', 'madar-lite'),
      'panel' => 'madarlite_category_color_panel'
   ));
   ...
   foreach ($categories as $category_list ) {
      ...
      $wp_customize->add_setting('madarlite_category_color_'.get_cat_id($wp_category_list[$category_list->cat_ID]), array(
         'default' => '',
         'capability' => 'edit_theme_options',
         'sanitize_callback' => 'madarlite_color_option_hex_sanitize',
         'sanitize_js_callback' => 'madarlite_color_escaping_option_sanitize'
      ));

      $wp_customize->add_control(new WP_Customize_Color_Control(
		  $wp_customize,
		  'madarlite_category_color_'.get_cat_id($wp_category_list[$category_list->cat_ID]),
		  array(
         'label' => sprintf(__('%s', 'madar-lite'), $wp_category_list[$category_list->cat_ID] ),
         'section' => 'madarlite_category_color_setting',
         'settings' => 'madarlite_category_color_'.get_cat_id($wp_category_list[$category_list->cat_ID]),
         'priority' => $i
      )));
      $i++;
   }
...
function madarlite_sanitize_blog( $input ) {
   ...
   // color sanitization
   function madarlite_color_option_hex_sanitize($color) {
   ...
   function madarlite_color_escaping_option_sanitize($input) {
